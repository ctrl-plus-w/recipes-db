...
const UpdateIngredientForm = ({ setIsOpen, recipe, ingredient }: IFormProps) => {
...
const UpdateIngredientFormDialog = ({ ingredient, recipe, children }: IProps) => {
  ...
  return (
    <AlertDialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <AlertDialogContent>
        ...
        <UpdateIngredientForm recipe={recipe} ingredient={ingredient} setIsOpen={setIsOpen} />
      </AlertDialogContent>
    </AlertDialog>
  );
};
